...
$sql= "SELECT * FROM users WHERE pass = '$username' AND repass = '$password' ";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto mr-5">
      ...
      <li class="nav-item">
        <a class="nav-link" href="facili.php">Facilities</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="about.php">About</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="contact.php" style="margin-right: 1.5rem;">Contact</a>
      </li>
      <li class="nav-item">
